...
export const NATIONAL_CONTENT: ChapterContent[] = [
  // ─── 1. Property Ownership ───
  {
    ...
    concepts: [
      { term: 'Real property', body: 'Land, the airspace above it, the minerals below, and anything permanently attached. Includes natural attachments (trees, water rights) and human-made improvements.' },
      { term: 'Personal property (chattel)', body: 'Movable items not affixed to land. Furniture, vehicles, equipment. Trade fixtures (tenant\'s business equipment) remain personal.' },
      { term: 'Fixture', body: 'A formerly-personal item that has become real property by attachment, adaptation, or intent. Built-in dishwashers, ceiling fans, and installed shelving typically qualify.' },
      { term: 'Trade fixture', body: 'Item installed by a tenant for business use. Remains personal property; tenant may remove it before lease ends if they repair damage caused.' },
      { term: 'MARIA test', body: 'Five-factor fixture analysis: Method, Adaptability, Relationship, Intent, Agreement. Courts use these to resolve fixture disputes.' },
      { term: 'Bundle of rights', body: 'The legal rights of ownership: possess, use, enjoy, exclude, dispose. Each "stick" can be sold or leased independently.' },
      { term: 'Fee simple absolute', body: 'The greatest possible ownership interest. Perpetual, inheritable, no conditions, freely transferable.' },
      { term: 'Defeasible fee', body: 'Fee subject to a condition. Fee simple determinable ends automatically on violation; fee simple subject to condition subsequent requires action by grantor to reclaim.' },
      { term: 'Life estate', body: 'Ownership for the duration of a measuring life. Reverts to grantor or passes to a named remainderman at the death of the measuring life.' },
      { term: 'Pur autre vie', body: 'Life estate measured by someone other than the holder\'s life ("for another\'s life").' },
      { term: 'Reversion', body: 'Future interest retained by the grantor when conveying a lesser estate. The estate "reverts" when the lesser estate ends.' },
      { term: 'Remainder', body: 'Future interest held by a named third party that takes effect when the prior estate ends.' },
      { term: 'Leasehold estate', body: 'Tenant\'s right to possess and use property for a defined term. Lower than freehold estates.' },
      { term: 'Estate for years', body: 'Lease with fixed beginning and end dates. Terminates automatically without notice.' },
      { term: 'Periodic estate', body: 'Lease that renews automatically — month-to-month, year-to-year. Notice required to terminate.' },
      { term: 'Estate at will', body: 'Terminable at any time by either party. No fixed term. Often arises from oral agreement.' },
      { term: 'Estate at sufferance', body: 'Holdover tenant remaining after lease ends without landlord\'s consent. Lower than estate at will.' },
      { term: 'Joint tenancy', body: 'Co-ownership with right of survivorship. Requires four unities: time, title, interest, possession. Avoids probate.' },
      { term: 'Four unities', body: 'Time (same moment), Title (same instrument), Interest (equal shares), Possession (right to whole). Required for valid joint tenancy.' },
      { term: 'Tenancy in common', body: 'Co-ownership with separate, inheritable, often unequal shares. No survivorship. Default form when intent is unclear.' },
      { term: 'Tenancy by the entirety', body: 'Spousal co-ownership with survivorship + protection from one spouse\'s individual creditors.' },
      { term: 'Severalty', body: 'Sole ownership by one person or legal entity. "Severed" from co-owners.' },
      { term: 'Lien', body: 'Monetary encumbrance attaching to property as security for debt. Priority generally follows recording date except for property tax liens.' },
      { term: 'Easement appurtenant', body: 'Easement attached to a specific parcel (dominant estate) that benefits the holder. Runs with the land — survives sale.' },
      { term: 'Easement in gross', body: 'Personal right to use land. Held by a person or entity (utility company), not attached to land. Does not run with the land typically.' },
      { term: 'Easement by prescription', body: 'Easement acquired through open, notorious, hostile, continuous use for the statutory period. Like adverse possession but for usage rights.' },
      { term: 'Encroachment', body: 'Unauthorized physical intrusion onto another\'s property — fence over the line, eaves overhanging. Discovered by survey; can ripen into prescriptive easement.' },
      { term: 'Bundle of rights metaphor', body: 'Each "stick" can be sold or leased independently — mineral rights, air rights, water rights, easements, leaseholds.' },
      { term: 'Riparian rights', body: 'Rights of an owner whose land borders a flowing watercourse (river, stream).' },
      { term: 'Littoral rights', body: 'Rights of an owner whose land borders a static body of water (lake, ocean).' },
    ],
    practice: [
      ...
      { q: 'Which is NOT a "stick" in the bundle of rights?', options: ['Right to possess', 'Right to exclude', 'Right to depreciate', 'Right to dispose'], correctIndex: 2, explain: 'Depreciation is a tax/accounting concept, not an ownership right.' },
      ...
      { q: 'Joint tenancy requires which four unities?', options: ['Time, title, intent, possession', 'Time, title, interest, possession', 'Title, interest, intent, agreement', 'Money, marriage, motive, manner'], correctIndex: 1, explain: 'Time, Title, Interest, Possession — TTIP.' },
      { q: 'A tenant operates a restaurant and installs a walk-in cooler. The cooler is:', options: ['A real-property fixture', 'A trade fixture', 'An emblement', 'An encroachment'], correctIndex: 1, explain: 'Tenant business equipment = trade fixture; remains personal property.' },
      { q: 'A holdover tenant who stays after the lease ends without landlord consent has:', options: ['Estate for years', 'Periodic estate', 'Estate at will', 'Estate at sufferance'], correctIndex: 3, explain: 'Sufferance = lowest estate, holdover without consent.' },
      { q: 'The right of an owner whose land borders a lake is called:', options: ['Riparian', 'Littoral', 'Prescriptive', 'Reversionary'], correctIndex: 1, explain: 'Littoral = static water (lake, ocean). Riparian = flowing (river, stream).' },
      { q: 'When a deed conveys property "to A for life, then to B," B holds:', options: ['A life estate', 'A reversion', 'A remainder', 'A leasehold'], correctIndex: 2, explain: 'B is the remainderman; the future interest passes to a named third party at A\'s death.' },
      { q: 'In a tenancy in common, when one owner dies their share:', options: ['Passes by survivorship to other owners', 'Passes by will or intestate succession', 'Reverts to the seller', 'Goes to the state'], correctIndex: 1, explain: 'Tenancy in common = no survivorship; share is inheritable.' },
    ],
  },
  ...
  // ─── 2. Land Use Controls ───
  {
    ...
    concepts: [
      { term: 'Police power', body: 'Government authority to regulate for health, safety, welfare. Source of zoning, building codes, environmental rules. No compensation required.' },
      { term: 'Eminent domain', body: 'Government power to take private property for public use with just compensation. Exercised through condemnation.' },
      { term: 'Inverse condemnation', body: 'Government action that effectively takes property without formal condemnation. Owner sues to force compensation.' },
      { term: 'Escheat', body: 'Property reverts to the state when owner dies intestate with no heirs.' },
      { term: 'Taxation power', body: 'Government authority to levy property taxes. Creates priority liens that survive most other claims.' },
      { term: 'Master plan / comprehensive plan', body: 'Long-term land-use vision document. Zoning is the implementation tool.' },
      { term: 'Zoning ordinance', body: 'Law dividing land into use districts (R, C, I, A) with density and dimensional rules.' },
      { term: 'Variance', body: 'Narrow exception to zoning for unique property hardship — not personal hardship. Granted by zoning board.' },
      { term: 'Conditional use permit', body: 'Permission for a use allowed in the zone subject to specific conditions. Pre-approved use type.' },
      { term: 'Special exception', body: 'Similar to conditional use; specific use permitted with conditions.' },
      { term: 'Nonconforming use', body: 'Pre-existing use that violates current zoning but is grandfathered. Cannot generally expand. May be amortized out.' },
      { term: 'Spot zoning', body: 'Singling out one parcel for different treatment. Generally unconstitutional unless serves genuine public purpose.' },
      { term: 'Setback', body: 'Required minimum distance between a structure and a property line.' },
      { term: 'Lot coverage', body: 'Percentage of lot that may be covered by buildings. Zoning limit.' },
      { term: 'FAR (floor area ratio)', body: 'Ratio of building floor area to lot area. Caps overall building size.' },
      { term: 'CC&Rs', body: 'Covenants, Conditions & Restrictions — private deed-based rules running with land. Enforced by HOA or neighbors.' },
      { term: 'Restrictive covenant', body: 'Promise running with land limiting use (no commercial, single-family only, etc.). Enforced via injunction or damages.' },
      { term: 'CERCLA / Superfund', body: 'Federal law imposing strict, joint and several liability for hazardous-waste cleanup on owners and operators.' },
      { term: 'Innocent landowner defense', body: 'Limited CERCLA defense for owner who did proper due diligence and didn\'t know of contamination.' },
      { term: 'Brownfield', body: 'Property complicated by potential or actual contamination. Often eligible for redevelopment incentives.' },
      { term: 'Wetlands', body: 'Federally regulated. Development typically requires Army Corps of Engineers permit.' },
      { term: 'Lead-based paint disclosure', body: 'Federal mandate for pre-1978 housing. Disclosure form + EPA pamphlet. Buyer 10-day inspection right.' },
      { term: 'Subdivision regulations', body: 'Rules controlling division of land into lots — platting, streets, infrastructure, environmental review.' },
      { term: 'Plat map', body: 'Recorded survey showing lots, streets, easements, dimensions within a subdivision.' },
      { term: 'Dedication', body: 'Voluntary transfer of private land to public use — typically streets, parks within a subdivision.' },
      { term: 'Special assessment', body: 'Charge against benefited property to fund a public improvement (sewer line, sidewalk). Becomes a lien.' },
    ],
    practice: [
      ...
      { q: 'PETE stands for:', options: ['Police, Eminent domain, Taxation, Escheat', 'Possession, Encroachment, Tax, Easement', 'Public, Eminent, Taking, Exchange', 'Property, Encumbrance, Title, Estate'], correctIndex: 0, explain: 'The four government powers over land.' },
      { q: 'Singling out one parcel for different zoning treatment is:', options: ['Variance', 'Conditional use', 'Spot zoning', 'Nonconforming use'], correctIndex: 2, explain: 'Spot zoning — generally unconstitutional unless serves public purpose.' },
      ...
      { q: 'A "brownfield" is:', options: ['A nature preserve', 'Property complicated by contamination concerns', 'Agricultural land', 'A subdivision in foreclosure'], correctIndex: 1, explain: 'Brownfield = potentially contaminated property, often redevelopable.' },
      { q: 'Government action that severely restricts use without formal condemnation may be:', options: ['Inverse condemnation', 'Police power', 'Escheat', 'Variance'], correctIndex: 0, explain: 'Inverse condemnation = de facto taking; owner sues for compensation.' },
      { q: 'Floor Area Ratio (FAR) limits:', options: ['How tall a building can be', 'The ratio of building floor area to lot area', 'How many stories are allowed', 'The setback requirement'], correctIndex: 1, explain: 'FAR caps overall building size relative to lot.' },
      { q: 'A daycare operating in a residential zone with a special permit is operating under a:', options: ['Variance', 'Conditional use permit', 'Nonconforming use', 'Spot zone'], correctIndex: 1, explain: 'Conditional uses are zone-permitted with specific conditions.' },
    ],
  },
  ...
  // ─── 3. Valuation & Market Analysis ───
  {
    ...
    concepts: [
      { term: 'Market value', body: 'Most probable price under arm\'s-length conditions with reasonable exposure to the open market.' },
      { term: 'Market price', body: 'Actual sale price. May differ from market value due to pressure, relationships, or imperfect information.' },
      { term: 'Cost', body: 'Money spent to acquire or build. Has no necessary relationship to value.' },
      { term: 'DUST', body: 'Demand, Utility, Scarcity, Transferability — the four characteristics required for value.' },
      { term: 'Substitution', body: 'A buyer will pay no more than the cost of an equally desirable substitute. Underlies all three valuation approaches.' },
      { term: 'Highest and best use', body: 'Use that is legally permissible, physically possible, financially feasible, and maximally productive. Four-part test.' },
      { term: 'Conformity', body: 'Properties hold value best when similar to neighbors. Outliers (too big, too small, too unusual) lose value.' },
      { term: 'Progression', body: 'A modest property gains value when surrounded by superior properties.' },
      { term: 'Regression', body: 'A superior property loses value when surrounded by modest properties.' },
      { term: 'Sales comparison approach', body: 'Adjust comparable sales for differences in size, location, condition, age, financing. Primary for residential.' },
      { term: 'Cost approach', body: 'Land value + depreciated cost of improvements. Best for new construction or unique/special-use property.' },
      { term: 'Income approach', body: 'Value = NOI ÷ Capitalization Rate. Used for income-producing property.' },
      { term: 'Reconciliation', body: 'Appraiser\'s weighted synthesis of the three approaches into a final value opinion.' },
      { term: 'Capitalization rate (cap rate)', body: 'NOI ÷ Value. Higher cap rate = higher perceived risk or weaker market. Solve for any of three variables.' },
      { term: 'Net Operating Income (NOI)', body: 'Effective Gross Income − Operating Expenses. Excludes mortgage payments (debt service) and income tax.' },
      { term: 'Effective Gross Income', body: 'Potential Gross Income − Vacancy and Collection Loss + Other Income.' },
      { term: 'Operating expenses', body: 'Recurring costs to operate property: taxes, insurance, utilities, maintenance, management. NOT debt service.' },
      { term: 'Gross Rent Multiplier (GRM)', body: 'Sale Price ÷ Monthly Gross Rent. Quick residential rental screen.' },
      { term: 'Gross Income Multiplier (GIM)', body: 'Sale Price ÷ Annual Gross Income. Used for larger income property.' },
      { term: 'Physical depreciation', body: 'Loss in value from wear, tear, deferred maintenance. Often curable.' },
      { term: 'Functional obsolescence', body: 'Outdated design or features — one bath in a four-bed house, narrow halls, awkward layout. Sometimes curable.' },
      { term: 'External obsolescence', body: 'Loss caused by factors outside the property — new freeway, neighborhood decline. Almost always incurable.' },
      { term: 'Curable vs incurable depreciation', body: 'Curable = cost to fix < value added. Incurable = not economically fixable.' },
      { term: 'Replacement cost', body: 'Cost to build a property of equivalent utility using current methods. Used in cost approach.' },
      { term: 'Reproduction cost', body: 'Cost to build an exact replica using original methods/materials. Used for historic properties.' },
      { term: 'CMA', body: 'Comparative Market Analysis — agent-prepared pricing recommendation. Not an appraisal.' },
      { term: 'BOV', body: 'Broker Opinion of Value. More formal than CMA, typically commercial.' },
      { term: 'Appraisal', body: 'Licensed appraiser\'s formal opinion of value. Required for federally related transactions.' },
      { term: 'USPAP', body: 'Uniform Standards of Professional Appraisal Practice. Federal appraiser ethics + methodology rules.' },
    ],
    practice: [
      ...
      { q: 'Highest and best use must be:', options: ['Profitable only', 'Physically possible only', 'Legally permissible, physically possible, financially feasible, maximally productive', 'Approved by the seller'], correctIndex: 2, explain: 'All four tests must be satisfied.' },
      { q: 'A modest property surrounded by larger, more expensive homes benefits from:', options: ['Regression', 'Progression', 'Conformity', 'Substitution'], correctIndex: 1, explain: 'Progression — modest property pulled up by superior neighbors.' },
      { q: 'A property generates $36,000 NOI. With market cap rate of 9%, value is:', options: ['$324,000', '$400,000', '$360,000', '$450,000'], correctIndex: 1, explain: '36,000 ÷ 0.09 = $400,000.' },
      { q: 'Mortgage payments (debt service) in NOI calculations are:', options: ['Operating expenses', 'NOT operating expenses', 'Capitalized', 'Treated as vacancy'], correctIndex: 1, explain: 'NOI excludes debt service. NOI is before financing.' },
      { q: 'A licensed appraisal differs from a CMA in that:', options: ['CMAs are more accurate', 'Appraisals require state licensing and follow USPAP', 'CMAs are required for federal loans', 'There is no difference'], correctIndex: 1, explain: 'Only state-licensed/certified appraisers can produce appraisals; CMAs are agent pricing recommendations.' },
      { q: 'Cap rate goes UP, value goes:', options: ['Up', 'Down', 'Stays the same', 'Depends on NOI'], correctIndex: 1, explain: 'V = NOI ÷ Cap. Higher cap (denominator) → lower value when NOI constant.' },
    ],
  },
  ...
  // ─── 4. Financing ───
  {
    ...
    concepts: [
      { term: 'Note', body: 'Borrower\'s personal promise to repay. Without it, no debt exists. Negotiable instrument.' },
      { term: 'Mortgage', body: 'Security instrument creating lender\'s lien on the property as collateral for the note. Two-party.' },
      { term: 'Deed of trust', body: 'Three-party security instrument: borrower (trustor), lender (beneficiary), neutral trustee. Used in title-theory states.' },
      { term: 'Lien theory state', body: 'Borrower keeps title, lender gets lien. Judicial foreclosure typical.' },
      { term: 'Title theory state', body: 'Lender holds title until loan paid. Non-judicial foreclosure possible.' },
      { term: 'Hypothecation', body: 'Pledging property as security without giving up possession.' },
      { term: 'LTV (Loan-to-Value)', body: 'Loan ÷ property value. PMI required above 80% LTV on conventional loans.' },
      { term: 'CLTV (Combined LTV)', body: 'All loans against property ÷ value. Includes second mortgages, HELOCs.' },
      { term: 'Equity', body: 'Property value minus all liens. Owner\'s actual stake.' },
      { term: 'Discount points', body: 'Prepaid interest. 1 point = 1% of loan amount. Lowers interest rate.' },
      { term: 'Origination fee', body: 'Lender charge for processing loan. Often 1% of loan.' },
      { term: 'APR', body: 'Annual Percentage Rate. Loan cost including interest + points + most fees. Required by Truth in Lending.' },
      { term: 'PMI', body: 'Private Mortgage Insurance. Required above 80% LTV conventional. Removed automatically at 78%.' },
      { term: 'FHA', body: 'Federal Housing Administration. Insures low-down-payment loans (3.5%+). Has upfront + annual MIP.' },
      { term: 'VA loan', body: 'Veterans Affairs guaranteed loan. No PMI. Often no down payment for eligible vets.' },
      { term: 'USDA loan', body: 'Rural housing program. No down payment in eligible areas.' },
      { term: 'Conforming loan', body: 'Meets Fannie/Freddie standards. Eligible for secondary market sale.' },
      { term: 'Jumbo loan', body: 'Exceeds conforming limits. Held by portfolio lenders or sold to non-GSE investors.' },
      { term: 'ARM', body: 'Adjustable Rate Mortgage. Rate = Index + Margin, adjusts on schedule. Has periodic + lifetime caps.' },
      { term: 'Index', body: 'Public benchmark rate (SOFR, prime, T-bill) used for ARM adjustments.' },
      { term: 'Margin', body: 'Lender\'s spread added to index to set ARM rate. Fixed for life of loan.' },
      { term: 'Cap', body: 'Limit on ARM rate adjustment — periodic (per adjustment), lifetime (over loan life).' },
      { term: 'Acceleration clause', body: 'On default, lender can demand entire balance immediately.' },
      { term: 'Due-on-sale (alienation) clause', body: 'Lender can call the loan if property is sold without consent. Prevents assumption.' },
      { term: 'Prepayment penalty', body: 'Fee for paying off loan early. Restricted on most owner-occupied mortgages.' },
      { term: 'Defeasance clause', body: 'States that lien is released when loan paid in full.' },
      { term: 'Subordination', body: 'Voluntary lowering of lien priority to allow new senior lien.' },
      ...
      { term: 'TRID', body: 'TILA-RESPA Integrated Disclosure rule. Combines disclosure requirements; sets timing rules.' },
      ...
      { term: 'Reverse mortgage', body: 'Senior converts equity into payments. Repaid when borrower dies, moves, or sells.' },
      { term: 'Predatory lending', body: 'Loans with excessive fees, unjustified rate hikes, no regard to ability to repay.' },
    ],
    practice: [
      ...
      { q: 'A "due-on-sale" clause:', options: ['Triggers automatic acceleration', 'Allows lender to call loan if property sold without consent', 'Is illegal', 'Applies only to FHA loans'], correctIndex: 1, explain: 'Alienation clause = prevents assumption without lender consent.' },
      { q: 'PMI is generally required on conventional loans when:', options: ['LTV is below 50%', 'LTV exceeds 80%', 'Loan exceeds $1M', 'Borrower has FICO below 600'], correctIndex: 1, explain: 'PMI protects lender on high-LTV conventional loans.' },
      { q: 'APR is generally:', options: ['Equal to interest rate', 'Lower than interest rate', 'Higher than interest rate when points charged', 'Always 0%'], correctIndex: 2, explain: 'APR includes points + most fees → higher than nominal interest rate.' },
      { q: 'RESPA Section 8 prohibits:', options: ['High interest rates', 'Kickbacks among settlement providers', 'FHA loans', 'Prepayment'], correctIndex: 1, explain: 'RESPA Section 8 bans referral fees / kickbacks.' },
      { q: 'A VA-eligible borrower typically:', options: ['Pays PMI', 'Has no down payment requirement', 'Cannot use VA twice', 'Must put down 20%'], correctIndex: 1, explain: 'VA loans often require no down payment and never PMI.' },
      { q: 'On an ARM, the rate equals:', options: ['Just the index', 'Index + margin', 'Index − margin', 'Margin only'], correctIndex: 1, explain: 'Rate = Index (variable) + Margin (fixed lender spread).' },
    ],
  },
  ...
  // ─── 5. Laws of Agency ───
  {
    ...
    concepts: [
      { term: 'Agent', body: 'Person authorized to act for and on behalf of a principal with authority to bind in dealings with third parties.' },
      ...
      { term: 'Fiduciary duties (COALD)', body: 'Care, Obedience, Accounting, Loyalty, Disclosure. Highest duties known to law.' },
      { term: 'Care', body: 'Act with diligence and skill a reasonable agent would use. Negligence is actionable.' },
      { term: 'Obedience', body: 'Follow lawful instructions. Refuse unlawful ones (discrimination, fraud, hiding defects).' },
      { term: 'Accounting', body: 'Maintain accurate records of all funds and property; deliver client funds promptly.' },
      { term: 'Loyalty', body: 'Place client\'s interests above all others, including agent\'s own. Avoid conflicts.' },
      { term: 'Disclosure (fiduciary)', body: 'Reveal all known material facts affecting client\'s decision. Including unfavorable info.' },
      ...
      { term: 'Subagency', body: 'Agent\'s authority delegated to another agent. Cooperating broker may be subagent of listing broker.' },
      { term: 'Designated agency', body: 'Within one brokerage, different agents represent opposite sides. Broker may be dual agent.' },
      ...
      { term: 'Buyer agency', body: 'Agent represents buyer\'s interests exclusively. Buyer-broker agreement creates relationship.' },
      { term: 'Tenant representation', body: 'Agent represents tenant. Common in commercial leasing.' },
      { term: 'Listing agreement', body: 'Contract creating seller-agent relationship.' },
      { term: 'Buyer-broker agreement', body: 'Contract creating buyer-agent relationship. Often includes compensation.' },
      { term: 'Express agency', body: 'Created by written or oral agreement.' },
      { term: 'Implied agency', body: 'Created by parties\' conduct without express agreement.' },
      { term: 'Ostensible / apparent agency', body: 'Principal\'s conduct leads third party to reasonably believe agency exists.' },
      { term: 'Agency by ratification', body: 'Principal accepts benefits of unauthorized act after the fact, creating retroactive agency.' },
      { term: 'Misrepresentation', body: 'False statement of material fact. Innocent, negligent, or fraudulent.' },
      { term: 'Puffing', body: 'Subjective sales talk ("best house on the street"). Not actionable.' },
      { term: 'Procuring cause', body: 'Origin of unbroken chain producing the sale. Determines commission entitlement in disputes.' },
      { term: 'Termination by operation of law', body: 'Death, incompetency, bankruptcy, destruction of subject matter, change in legal status.' },
      { term: 'Confidentiality', body: 'Agent\'s duty to protect client information. Survives agency termination.' },
    ],
    practice: [
      ...
      { q: '"This is a great property" is most likely:', options: ['Misrepresentation', 'Fraud', 'Puffing', 'Material fact'], correctIndex: 2, explain: 'Subjective opinion = puffing, not actionable.' },
      { q: 'A buyer-broker agreement creates:', options: ['Subagency only', 'A fiduciary relationship with the buyer', 'A customer relationship', 'No legal relationship'], correctIndex: 1, explain: 'Buyer-broker agreement = express agency with buyer as principal.' },
      { q: 'When an agent\'s authority is delegated to another agent in a different brokerage, it\'s called:', options: ['Dual agency', 'Subagency', 'Universal agency', 'Implied agency'], correctIndex: 1, explain: 'Subagency = delegated authority. Cooperating broker as subagent of listing broker.' },
      { q: 'A power of attorney typically creates a:', options: ['Special agency', 'General agency', 'Universal agency', 'Subagency'], correctIndex: 2, explain: 'POA = authority to act in all (legal) matters = universal agency.' },
      { q: 'Confidentiality duty:', options: ['Ends at closing', 'Continues after agency termination', 'Applies only to commercial transactions', 'Applies only to written information'], correctIndex: 1, explain: 'Confidentiality survives agency termination.' },
      { q: 'A seller tells the agent the basement floods. The agent is asked by a buyer about water issues. The agent must:', options: ['Honor seller wishes and stay silent', 'Disclose the known defect', 'Disclose only if buyer asks twice', 'Refer the buyer to the seller only'], correctIndex: 1, explain: 'Material defects must be disclosed to all parties; agent has independent duty.' },
    ],
  },
  ...
  // ─── 6. Mandated Disclosures ───
  {
    ...
    concepts: [
      ...
      { term: 'Innocent misrepresentation', body: 'False statement made without knowledge of falsity. Still actionable for rescission.' },
      { term: 'Negligent misrepresentation', body: 'False statement that should have been verified. Damages available.' },
      { term: 'Fraudulent misrepresentation', body: 'Intentional false statement. Punitive damages possible.' },
      { term: 'Misrepresentation by silence', body: 'Failure to disclose a known material fact. Actionable as fraud.' },
      { term: 'Puffing', body: 'Subjective sales talk ("this is the best house"). Not actionable.' },
      { term: 'Lead-Based Paint Disclosure', body: 'Federal law requires for pre-1978 housing. Buyer gets 10-day inspection window + EPA pamphlet + disclosure form.' },
      { term: 'Megan\'s Law', body: 'Sex offender registration disclosure. State rules vary on agent duty.' },
      { term: 'Stigmatized property', body: 'Property with non-physical issue (death, crime, alleged haunting). State rules vary on disclosure.' },
      { term: 'Caveat emptor', body: '"Let the buyer beware." Largely supplanted by mandatory disclosure laws for residential.' },
      { term: 'Caveat venditor', body: '"Let the seller beware." Modern leaning — sellers must disclose.' },
      { term: 'Latent defect', body: 'Hidden defect not discoverable on reasonable inspection. Must be disclosed if known.' },
      { term: 'Patent defect', body: 'Obvious defect visible on reasonable inspection. Generally presumed observed by buyer.' },
      { term: 'Red flag', body: 'A visible condition prompting inquiry — water stains, sloping floor, recent isolated paint. Triggers duty to investigate or recommend inspection.' },
      { term: 'As-is sale', body: 'Buyer takes property in current condition. Does NOT eliminate disclosure obligations.' },
      { term: 'CERCLA / Superfund', body: 'Federal environmental cleanup law. Strict, joint and several liability.' },
      { term: 'Mold disclosure', body: 'Required in many states. Toxic mold (Stachybotrys) is a major concern.' },
      { term: 'Radon disclosure', body: 'Naturally occurring radioactive gas. Federal pamphlet recommended.' },
      { term: 'Asbestos', body: 'Common in pre-1980 construction. Federal AHERA rules for schools; private property has fewer.' },
      { term: 'Underground storage tank', body: 'Common environmental issue on commercial property. RCRA regulated.' },
      { term: 'Mello-Roos / special districts', body: 'Tax districts for new development infrastructure (CA term; analogous in other states). Disclosable.' },
      { term: 'Property condition disclosure', body: 'State-mandated form listing known material facts about property condition.' },
    ],
    practice: [
      ...
      { q: 'Lead-based paint buyer\'s right to inspect is:', options: ['3 days', '10 days', '14 days', '30 days'], correctIndex: 1, explain: '10-day right to inspect; can be waived in writing.' },
      { q: 'A reasonable buyer would consider it important = the fact is:', options: ['Material', 'Stigmatizing', 'Patent', 'Puffing'], correctIndex: 0, explain: 'Materiality standard is "would a reasonable party consider it important?"' },
      { q: 'A statement made without knowing it is false but that should have been verified is:', options: ['Innocent misrepresentation', 'Negligent misrepresentation', 'Fraudulent misrepresentation', 'Puffing'], correctIndex: 1, explain: 'Negligent = should have known.' },
      { q: 'The historical "let the buyer beware" doctrine is:', options: ['Caveat venditor', 'Caveat emptor', 'Quid pro quo', 'Statute of frauds'], correctIndex: 1, explain: 'Caveat emptor = buyer beware.' },
      { q: 'A licensee notices fresh paint over one wall in a basement and water stains nearby. The licensee should:', options: ['Ignore — buyer\'s problem', 'Investigate or recommend inspection', 'Tell only the listing broker', 'Wait for the buyer to ask'], correctIndex: 1, explain: 'Red flag = duty to inquire or recommend inspection.' },
      { q: 'A seller refuses to complete the property condition disclosure form. The licensee should:', options: ['Submit the listing without it', 'Insist on completion or decline the listing', 'Complete it themselves', 'Only disclose to buyers who ask'], correctIndex: 1, explain: 'Most states require completed seller disclosure; refusal often means walking away.' },
      { q: 'Stigmatized property disclosure rules:', options: ['Are uniform federally', 'Vary by state', 'Don\'t exist', 'Only apply to murder'], correctIndex: 1, explain: 'State-specific. Some require, some don\'t.' },
    ],
  },
  ...
  // ─── 7. Contracts ───
  {
    ...
    concepts: [
      { term: 'Statute of Frauds', body: 'Real estate contracts must be in writing and signed to be enforceable.' },
      { term: 'Mutual agreement', body: 'Offer + acceptance. "Meeting of the minds" on essential terms.' },
      { term: 'Offer', body: 'Definite proposal communicated with intent to be bound on acceptance.' },
      { term: 'Acceptance', body: 'Unconditional agreement to all material terms. Communication required.' },
      { term: 'Counteroffer', body: 'Conditional acceptance (changed terms). Rejection + new offer. Cancels original.' },
      { term: 'Consideration', body: 'Something of value exchanged. Money, property, services, promises.' },
      { term: 'Capacity', body: 'Legal ability to contract. Minors, incompetents, intoxicated have limited capacity.' },
      { term: 'Lawful purpose', body: 'Object of contract must be legal. Illegal contracts are void.' },
      { term: 'Bilateral contract', body: 'Both parties make promises. Most real estate contracts.' },
      { term: 'Unilateral contract', body: 'One party makes a promise; other accepts by performance (e.g., reward).' },
      { term: 'Express contract', body: 'Terms stated in words (written or oral).' },
      { term: 'Implied contract', body: 'Terms inferred from conduct.' },
      { term: 'Executory contract', body: 'Not yet fully performed.' },
      { term: 'Executed contract', body: 'Fully performed.' },
      { term: 'Valid contract', body: 'Has all elements; enforceable.' },
      { term: 'Void contract', body: 'No legal effect from inception. Illegal purpose, lack of capacity.' },
      { term: 'Voidable contract', body: 'One party can rescind. Minor\'s contract; contract induced by fraud.' },
      { term: 'Unenforceable contract', body: 'Valid in form but court won\'t enforce. Statute of frauds violation, statute of limitations.' },
      { term: 'Exclusive Right to Sell', body: 'Broker earns commission regardless of who produces the buyer.' },
      { term: 'Exclusive Agency', body: 'Broker earns unless seller personally finds the buyer.' },
      ...
      { term: 'Multiple Listing Service (MLS)', body: 'Cooperative database where listing brokers share listings with cooperating brokers.' },
      { term: 'Earnest money', body: 'Buyer\'s good-faith deposit, typically held in trust by escrow or broker.' },
      { term: 'Contingency', body: 'Condition that must be met for the contract to proceed. Failure = termination.' },
      { term: 'Specific performance', body: 'Court orders actual conveyance. Common remedy for breach by seller because real estate is unique.' },
      { term: 'Liquidated damages', body: 'Pre-agreed damages amount, usually the earnest money. Avoids fact-finding.' },
      { term: 'Compensatory damages', body: 'Actual losses (lost profits, costs). Available for breach.' },
      { term: 'Rescission', body: 'Termination of contract returning parties to pre-contract position.' },
      { term: 'Mutual rescission', body: 'Both parties agree to cancel.' },
      { term: 'Novation', body: 'Substitution of new party or new contract by all parties\' consent. Releases original obligor.' },
      { term: 'Assignment', body: 'Transfer of contract rights to a third party. Generally allowed unless barred.' },
      { term: 'Time is of the essence', body: 'Deadlines strictly enforced. Late performance = breach.' },
      { term: 'Mitigation', body: 'Non-breaching party must take reasonable steps to minimize damages.' },
      { term: 'Option contract', body: 'Right (not obligation) to buy at stated price within stated time. Optionee pays consideration for option.' },
      { term: 'Right of first refusal', body: 'Right to match a bona fide third-party offer before owner accepts it.' },
      { term: 'Duress', body: 'Improper pressure invalidating consent. Voidable.' },
      { term: 'Undue influence', body: 'Excessive psychological pressure by trusted person. Voidable.' },
      { term: 'Mistake', body: 'Material misunderstanding of facts. Mutual mistake → rescission. Unilateral generally not.' },
    ],
    practice: [
      ...
      { q: 'A contract signed under improper pressure is:', options: ['Void', 'Voidable', 'Unenforceable', 'Executed'], correctIndex: 1, explain: 'Duress makes a contract voidable at the harmed party\'s election.' },
      { q: 'Substitution of a new party with all parties\' consent is:', options: ['Assignment', 'Novation', 'Rescission', 'Reformation'], correctIndex: 1, explain: 'Novation releases the original obligor and substitutes a new one.' },
      { q: 'An option contract requires:', options: ['Equal exchange', 'Consideration paid by optionee for the option', 'A 30-day exercise period', 'Notarization'], correctIndex: 1, explain: 'Optionee must pay something to keep the option open.' },
      { q: 'A contingency that fails:', options: ['Forces the contract to close anyway', 'Generally terminates the contract with deposit returned', 'Triggers liquidated damages', 'Voids the listing'], correctIndex: 1, explain: 'Failed contingency typically allows termination and deposit return.' },
      { q: 'A right of first refusal allows the holder to:', options: ['Buy at any price', 'Match a bona fide third-party offer', 'Refuse all offers', 'Force a sale'], correctIndex: 1, explain: 'ROFR = right to match the deal someone else has offered.' },
      { q: 'A minor\'s contract is generally:', options: ['Void', 'Voidable by the minor', 'Voidable by the adult', 'Unenforceable'], correctIndex: 1, explain: 'Minors can affirm or disaffirm; protection runs to the minor.' },
    ],
  },
  ...
  // ─── 8. Transfer of Title ───
  {
    ...
    concepts: [
      ...
      { term: 'Grantor / Grantee', body: 'Grantor = transferor (signs deed). Grantee = recipient.' },
      ...
      { term: 'Granting clause', body: 'States the conveyance and consideration.' },
      { term: 'Consideration recital', body: 'Statement of value exchanged. May be nominal ("$10 and other valuable consideration").' },
      { term: 'Legal description', body: 'Precise identification of property: metes and bounds, lot and block, government rectangular survey.' },
      { term: 'Acknowledgment', body: 'Notarized statement that signature was made voluntarily. Required for recording, not validity.' },
      ...
      { term: 'General warranty deed', body: 'Strongest deed. Five covenants. Warranties run back to property\'s origin.' },
      { term: 'Special / limited warranty deed', body: 'Warrants only against defects arising during grantor\'s ownership.' },
      { term: 'Bargain and sale deed', body: 'Implies grantor has title; no express warranties.' },
      { term: 'Quitclaim deed', body: 'Conveys whatever interest grantor has; no warranties. Used to clear title clouds.' },
      { term: 'Sheriff\'s deed', body: 'Transfers title from foreclosure sale or judgment execution.' },
      { term: 'Tax deed', body: 'Transfers title from tax foreclosure sale.' },
      ...
      { term: 'Actual notice', body: 'Subjective knowledge of fact.' },
      { term: 'Inquiry notice', body: 'Notice imputed when facts would prompt a reasonable person to investigate.' },
      { term: 'Title insurance', body: 'Protects against title defects existing at closing. Owner\'s + lender\'s policies.' },
      { term: 'Chain of title', body: 'Recorded history of ownership.' },
      { term: 'Title abstract', body: 'Summary report of chain of title.' },
      { term: 'Title commitment', body: 'Insurer\'s preliminary report identifying issues to clear before closing.' },
      ...
      { term: 'Marketable title', body: 'Title free of significant clouds, acceptable to a reasonable buyer.' },
      ...
      { term: 'Intestate succession', body: 'Statutory order of heirs when no will.' },
      { term: 'Letters testamentary / administration', body: 'Court documents authorizing personal representative to act.' },
      { term: 'Escrow agent', body: 'Neutral third party holding funds + documents and disbursing per instructions.' },
      { term: 'Closing Disclosure', body: 'Federal form summarizing loan + closing costs. Replaced HUD-1 for most residential.' },
      { term: 'Conveyance tax / transfer tax', body: 'State or local tax on real property transfers.' },
      { term: 'Proration', body: 'Splitting shared expenses at closing.' },
    ],
    practice: [
      ...
      { q: 'Title insurance protects against:', options: ['Future title problems', 'Defects existing at closing', 'Property damage', 'Loan default'], correctIndex: 1, explain: 'Title insurance covers title defects existing at closing time.' },
      { q: 'A lender\'s title policy:', options: ['Covers the buyer', 'Covers the lender for loan amount', 'Is optional', 'Replaces homeowner\'s insurance'], correctIndex: 1, explain: 'Lender\'s policy covers the loan amount and decreases as loan is paid down.' },
      { q: 'Property held in joint tenancy passes at death:', options: ['Through probate', 'By survivorship outside probate', 'By intestate succession', 'To the trustee'], correctIndex: 1, explain: 'Joint tenancy avoids probate via right of survivorship.' },
      { q: 'A "cloud on title" is:', options: ['A weather event', 'An unresolved title claim or defect', 'A type of warranty', 'A federal lien'], correctIndex: 1, explain: 'Cloud = title defect or unresolved claim.' },
      { q: 'A deed must be signed by:', options: ['Grantor only', 'Grantee only', 'Both parties', 'A notary only'], correctIndex: 0, explain: 'Only the grantor signs the deed.' },
      { q: 'The federal closing form for most residential mortgage loans is:', options: ['HUD-1', 'Closing Disclosure', 'Settlement Statement', 'Truth in Lending'], correctIndex: 1, explain: 'CD replaced HUD-1 for TRID loans.' },
      { q: '"To have and to hold" language is the:', options: ['Granting clause', 'Habendum clause', 'Acknowledgment', 'Recital'], correctIndex: 1, explain: 'Habendum defines the extent of estate granted.' },
    ],
  },
  ...
  // ─── 9. Practice of Real Estate ───
  {
    ...
    concepts: [
      ...
      { term: 'Reconciliation', body: 'Periodic verification (typically monthly) that trust account balance matches owed amounts.' },
      { term: 'Fair Housing Act (1968 + amendments)', body: 'Federal law banning discrimination in housing on 7 protected bases.' },
      { term: 'Civil Rights Act of 1866', body: 'Prohibits race discrimination in all property transactions. No exceptions.' },
      { term: 'Protected class (federal)', body: 'Race, color, national origin, religion, sex, familial status, disability.' },
      { term: 'Protected class (Hawaii HRS 515)', body: 'Federal + ancestry, age, marital status, sexual orientation, gender identity, HIV, source of income.' },
      { term: 'Familial status', body: 'Presence of children under 18 (or pregnant). Senior housing has narrow exception.' },
      ...
      { term: 'Discriminatory advertising', body: 'Ads suggesting preference for/against any protected class. Illegal.' },
      { term: 'ADA', body: 'Americans with Disabilities Act. Accessibility in public accommodations and commercial.' },
      { term: 'Sherman Antitrust Act', body: 'Federal antitrust. Price fixing, market allocation, group boycotts are per se illegal.' },
      { term: 'Price fixing', body: 'Brokers agreeing on commission rates. Per se Sherman violation.' },
      { term: 'Market allocation', body: 'Brokers agreeing to divide territory or customers. Per se illegal.' },
      { term: 'Group boycott', body: 'Brokers agreeing to refuse dealings with another firm. Per se illegal.' },
      { term: 'Tying arrangement', body: 'Forcing customer to buy product B to get product A. Antitrust scrutiny.' },
      { term: 'Independent contractor', body: 'Agent classified for tax purposes; broker still supervises for license law.' },
      { term: 'Failure to supervise', body: 'Broker liability for licensee\'s violations. Can revoke broker license.' },
      ...
      { term: 'Unauthorized practice of law (UPL)', body: 'Drafting contracts, giving legal advice, interpreting documents — agent must avoid.' },
      { term: 'Truth in advertising', body: 'Ads must accurately reflect property, firm, and licensee status.' },
      { term: 'Continuing education', body: 'Ongoing training required for license renewal. Hours and topics vary by state.' },
      { term: 'RESPA Section 8', body: 'Bans kickbacks and unearned fees among settlement service providers.' },
    ],
    practice: [
      ...
      { q: '"Familial status" protection includes:', options: ['Married couples only', 'Adults only', 'Households with children under 18 or pregnant', 'Senior citizens only'], correctIndex: 2, explain: 'Familial status = children under 18, with narrow senior-housing exception.' },
      { q: 'When a broker says "What is the going commission rate?", the proper answer is:', options: ['"6%"', '"Commissions are negotiable"', '"Whatever others charge"', '"Industry standard 7%"'], correctIndex: 1, explain: 'Quoting "going rate" risks antitrust evidence; commissions are negotiable.' },
      { q: 'NAR Code of Ethics:', options: ['Is state law', 'Binds all licensees', 'Binds REALTOR® members voluntarily', 'Replaces license law'], correctIndex: 2, explain: 'NAR Code is voluntary professional designation; license law is state-mandatory.' },
      { q: 'Brokers must reconcile trust accounts:', options: ['Annually', 'Quarterly', 'Typically monthly', 'Never'], correctIndex: 2, explain: 'Most states require monthly trust account reconciliation.' },
      { q: 'A broker drafts a custom addendum modifying a standard contract\'s default terms. This may be:', options: ['Permitted always', 'Unauthorized practice of law', 'Required by license law', 'Antitrust'], correctIndex: 1, explain: 'Drafting custom legal language is UPL territory; agents fill blanks, lawyers draft.' },
      { q: 'A failure-to-supervise charge can revoke:', options: ['Only the agent\'s license', 'Only the broker\'s license', 'Both broker and agent licenses', 'Neither'], correctIndex: 2, explain: 'Both can be sanctioned; broker for failure to supervise, agent for the underlying violation.' },
      { q: 'Civil Rights Act of 1866 covers:', options: ['Sex only', 'Race in all property transactions', 'Religion only', 'Familial status'], correctIndex: 1, explain: '1866 Act covers race in all property; no exceptions.' },
    ],
  },
  ...
  // ─── 10. Real Estate Calculations ───
  {
    ...
    concepts: [
      ...
      { term: 'Section', body: '640 acres = 1 square mile = 5,280 ft × 5,280 ft.' },
      { term: 'Square foot ↔ square yard', body: '1 sq yard = 9 sq ft.' },
      { term: 'Triangle area', body: '½ × Base × Height.' },
      { term: 'Circle area', body: 'π × radius² (≈ 3.14 × r²).' },
      { term: 'Commission formula', body: 'Sale Price × Commission Rate = Total Commission. Then split.' },
      { term: 'LTV formula', body: 'Loan ÷ Value.' },
      { term: 'Down payment', body: 'Value − Loan.' },
      { term: 'Discount point', body: '1% of loan amount. Reduces rate roughly 0.25% per point.' },
      ...
      { term: 'GRM formula', body: 'Sale Price ÷ Monthly Rent.' },
      { term: 'GIM formula', body: 'Sale Price ÷ Annual Gross Income.' },
      { term: 'Proration (360-day)', body: 'Annual ÷ 360 = daily; multiply by days owed. Used in many contracts.' },
      { term: 'Proration (365-day)', body: 'Annual ÷ 365 = daily; some contracts use actual day count.' },
      { term: 'Mill rate', body: 'Property tax = Assessed Value × Mills ÷ 1,000. One mill = $1 per $1,000.' },
      { term: 'Daily interest', body: 'Loan × Rate ÷ 360 (or 365). Used for partial-period interest calculations.' },
      { term: 'Profit percentage', body: '(Sale Price − Cost) ÷ Cost × 100.' },
      { term: 'Conveyance tax', body: 'Often calculated as rate per $1,000 of sale price.' },
    ],
    practice: [
      ...
      { q: 'Annual taxes $3,600; closing on April 1 (360-day year, seller pays through closing day). Seller\'s prorated share:', options: ['$300', '$600', '$900', '$1,200'], correctIndex: 2, explain: '$3,600 × 90/360 = $900 (Jan 1 – Apr 1, 90 days).' },
      { q: 'A house sells for $450,000. The buyer puts down 20% and finances the rest. The loan amount is:', options: ['$90,000', '$360,000', '$405,000', '$450,000'], correctIndex: 1, explain: '$450,000 × 0.80 = $360,000.' },
      { q: 'How many sections in a township?', options: ['16', '24', '36', '64'], correctIndex: 2, explain: 'A township is 6 mi × 6 mi = 36 sections.' },
      { q: 'A property has a mill rate of 25 mills and assessed value of $200,000. Annual property tax:', options: ['$500', '$5,000', '$50,000', '$25,000'], correctIndex: 1, explain: '$200,000 × 25 ÷ 1,000 = $5,000.' },
      { q: 'A duplex rents for $1,800/month combined. Comparables suggest GRM = 130. Estimated value:', options: ['$180,000', '$234,000', '$216,000', '$260,000'], correctIndex: 1, explain: '$1,800 × 130 = $234,000.' },
      { q: 'A commission split is: 50% to listing brokerage, 50% to selling brokerage; agent gets 70% of their brokerage\'s share. Sale price $400,000, commission 6%. Listing agent\'s personal share:', options: ['$4,200', '$8,400', '$12,000', '$24,000'], correctIndex: 1, explain: '6% × $400K = $24K. Listing brokerage gets $12K. Agent gets 70% = $8,400.' },
      { q: 'A property cost $200,000 and sold for $260,000. Profit % is:', options: ['20%', '23%', '30%', '60%'], correctIndex: 2, explain: '($260K − $200K) ÷ $200K = 30%.' },
      { q: 'Daily interest on a $200,000 loan at 6% (360-day year):', options: ['$33.33', '$32.88', '$200', '$10'], correctIndex: 0, explain: '$200,000 × 6% = $12,000 annual; ÷ 360 = $33.33 per day.' },
    ],
  },
  ...
  // ─── 11. Specialty Areas ───
  {
    ...
    concepts: [
      ...
      { term: 'Management agreement', body: 'Contract creating PM-owner relationship. Typically defines compensation, scope, term.' },
      ...
      { term: 'Proprietary lease', body: 'Co-op shareholder\'s right to occupy a specific unit.' },
      ...
      { term: 'Dedication', body: 'Voluntary transfer of private land to public use (typically streets).' },
      { term: 'Interstate Land Sales Full Disclosure Act', body: 'Federal law requiring registration + property report for cross-state sales of unimproved lots.' },
      ...
      { term: 'Percentage lease', body: 'Base rent + % of sales over threshold. Common in retail.' },
      { term: 'Ground lease', body: 'Tenant rents land, often builds own structure.' },
      { term: 'DSCR', body: 'Debt Service Coverage Ratio = NOI ÷ Annual Debt Service. Lenders want 1.20+.' },
      { term: 'Cash-on-cash return', body: 'Annual cash flow before tax ÷ cash invested.' },
      { term: 'IRR', body: 'Internal Rate of Return. Considers timing of cash flows + reversion.' },
      { term: 'Equity multiplier', body: 'Total return over holding period ÷ initial equity invested.' },
      { term: 'Vacancy rate', body: 'Vacant units ÷ total units. Affects effective gross income.' },
    ],
    practice: [
      ...
      { q: 'A retail tenant in a percentage lease pays:', options: ['Only the percentage', 'Base rent + percentage of sales over a threshold', 'Triple net only', 'Gross lease only'], correctIndex: 1, explain: 'Percentage leases are base rent + sales percentage.' },
      { q: 'A ground lease typically:', options: ['Includes the building', 'Is for the land only, with tenant building structures', 'Lasts 1 year', 'Cannot be assigned'], correctIndex: 1, explain: 'Tenant rents land and builds.' },
      { q: 'The Interstate Land Sales Full Disclosure Act applies to:', options: ['All real estate sales', 'Cross-state sales of unimproved lots in larger developments', 'Single-family resales only', 'Commercial sales only'], correctIndex: 1, explain: 'ILSA covers cross-state subdivision marketing.' },
      { q: 'DSCR below 1.0 means:', options: ['Property generates more income than debt service', 'Property has insufficient income to cover debt', 'No debt', 'Cap rate above 10%'], correctIndex: 1, explain: 'DSCR < 1.0 = NOI insufficient to cover debt service.' },
      { q: 'A property manager\'s standard compensation is most often:', options: ['Hourly', 'Percentage of rents collected', 'Flat year-end', 'Equity stake'], correctIndex: 1, explain: 'Percentage of rents (often 6-10% residential) is standard.' },
      { q: 'A vacant unit\'s impact on NOI:', options: ['No effect', 'Reduces effective gross income', 'Increases NOI', 'Only affects taxes'], correctIndex: 1, explain: 'Vacancy reduces effective gross income, which reduces NOI.' },
    ],
  },
];
